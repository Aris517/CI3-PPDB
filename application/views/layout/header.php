            ...
            <div>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav">
                        ...
                        <?php if ($this->session->userdata('role') !== 'cpd') : ?>
                            <li class="nav-small-cap">
                                <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                                <span class="hide-menu">Kelola Data</span>
                            </li>
                        <?php endif ?>
                        <?php if ($this->session->userdata('role') === 'admin'  || $this->session->userdata('role') === 'panitia') : ?>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="<?= base_url('pendaftaran/manage') ?>" aria-expanded="false">
                                    <span>
                        ...
                        <?php if ($this->session->userdata('role') === 'admin') : ?>
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="<?= base_url('pengumuman/manage') ?>" aria-expanded="false">
                                    <span>
                                        <i class="ti ti-article"></i>
                                    </span>
                                    <span class="hide-menu">Kelola Pengumuman</span>
                                </a>
                            </li>
                        <?php endif ?>
                        <?php if ($this->session->userdata('role') === 'ks') : ?>
                            ...
                            <li class="sidebar-item">
                                <a class="sidebar-link" href="<?= base_url('akun/manage') ?>" aria-expanded="false">
                                    <span>
                                        <i class="ti ti-article"></i>
                                    </span>
